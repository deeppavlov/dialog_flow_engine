...
script = {
    ...
    "global_flow": {
        "start_node": {RESPONSE: "INITIAL NODE", TRANSITIONS: {("flow", "node_hi"): cnd.regexp(r"base"),
                                                               "fallback_node": cnd.true()}},
        "fallback_node": {RESPONSE: "oops", TRANSITIONS: {lbl.previous(): cnd.exact_match("initial"),
    ...
    "flow": {LOCAL: {MISC: {
        ...
        "node_hi": {MISC: {"var3": "rewrite_by_hi"},
                    PRE_RESPONSE_PROCESSING: {"proc_name_1": add_prefix("l1_flow_hi"),
        ...
        "node_no": {MISC: {"var3": "rewrite_by_NO"},
                    PRE_RESPONSE_PROCESSING: {"proc_name_1": add_prefix("l1_flow_no"),
                                              "proc_name_2": add_prefix("l2_flow_no"), "proc_name_3": add_misc()},
        ...
        "node_complex": {
            ...
            PRE_RESPONSE_PROCESSING: {"proc_name_1": add_prefix("l1_flow_complex"),
                                      "proc_name_2": add_prefix("l2_flow_complex"), "proc_name_3": add_misc()},
        ...
        "node_ok": {MISC: {"var3": "rewrite_by_OK"},
                    PRE_RESPONSE_PROCESSING: {"proc_name_1": add_prefix("l1_flow_ok"),
                                              "proc_name_2": add_prefix("l2_flow_ok"), "proc_name_3": add_misc()},
...
# init actor
actor = Actor(script, start_label=("global_flow", "start_node"), fallback_label=("global_flow", "fallback_node"),
              label_priority=1.0)
